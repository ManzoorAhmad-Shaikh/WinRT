...
int initialize(void)
{
	...
	RM[0] = cos(angleRotate); RM[1] = 0.0f; RM[2] = -sin(angleRotate); RM[3] = 0.0f;
	RM[4] = 0.0f; RM[5] = 1.0f; RM[6] = 0.0f; RM[7] = 0.0f;
	RM[8] = sin(angleRotate); RM[9] = 0.0f; RM[10] = cos(angleRotate); RM[11] = 0.0f;
